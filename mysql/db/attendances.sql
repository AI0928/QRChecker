...
CREATE TABLE attendances (
  ...
  `lecture_number` INT,
  `user_number` INT,
  `first` VARCHAR(5) default "-",
  `second` VARCHAR(5) default "-",
  `third` VARCHAR(5) default "-",
  `fourth` VARCHAR(5) default "-",
  `fifth` VARCHAR(5) default "-",
  `sixth` VARCHAR(5) default "-",
  `seventh` VARCHAR(5) default "-",
  `eighth` VARCHAR(5) default "-",
  `ninth` VARCHAR(5) default "-",
  `tenth` VARCHAR(5) default "-",
  `eleventh` VARCHAR(5) default "-",
  `twelfth` VARCHAR(5) default "-",
  `thirteenth` VARCHAR(5) default "-",
  `fourteenth` VARCHAR(5) default "-",
  `fifteenth` VARCHAR(5) default "-",
  PRIMARY KEY (`id`)
);

INSERT INTO attendances (id, lecture_number, user_number) VALUES (1, 1000, 1000)
